    ...
    <main className="min-h-screen bg-gray-50 px-6 py-14">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">Wir erheben und verarbeiten folgende personenbezogene Daten:</p>

          <p className="mt-3 font-medium text-gray-800">Schülerinnen &amp; Schüler</p>
          <ul className="list-disc ml-5 mt-1 space-y-1 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">3. Minderjährige</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">4. Cookies &amp; Einwilligung</h2>
          ...
          <ul className="list-disc ml-5 mt-2 space-y-1 text-gray-700 leading-relaxed">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">5. Zweck der Verarbeitung</h2>
          <ul className="list-disc ml-5 space-y-1 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">6. Rechtsgrundlage</h2>
          <ul className="list-disc ml-5 mt-2 space-y-1 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">7. Drittanbieter</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">8. Speicherdauer</h2>
          <ul className="list-disc ml-5 space-y-1 text-gray-700 leading-relaxed">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">9. Deine Rechte</h2>
          <p className="text-gray-700 leading-relaxed">Du hast folgende Rechte gemäß DSGVO:</p>
          <ul className="list-disc ml-5 mt-2 space-y-1 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">10. Änderungen</h2>
          <p className="text-gray-700 leading-relaxed">
