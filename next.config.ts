...
const securityHeaders = [
  ...
  // frame-src für Stripe Checkout
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "connect-src 'self' https://api.stripe.com https://checkout.stripe.com https://pagead2.googlesyndication.com https://adservice.google.com wss:",
      "frame-src https://js.stripe.com https://hooks.stripe.com https://connect.stripe.com https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://www.google.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
    ].join("; "),
